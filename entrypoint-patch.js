...
if (fs.existsSync(indexPath)) {
  ...
  html = html.replace(
    /<script src="\/(cloud-(early-restore|save)|virtual-controls|pause-protect|mute-control|metadata-enhance)\.js[^"]*"><\/script>\n?\s*/g,
    ''
  );
