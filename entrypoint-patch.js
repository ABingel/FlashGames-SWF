...
try {
  ...
  if (fs.existsSync(assetsDir)) {
    for (const name of fs.readdirSync(assetsDir)) {
      ...
      const fontPatch = `fontSources:["/fonts/NotoSansSC-Raised.ttf","/fonts/NotoSansSC-Regular.ttf","/fonts/DroidSansFallbackFull.ttf"],defaultFonts:{sans:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),serif:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),typewriter:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),SimSun:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),宋体:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),SimHei:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),黑体:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),微软雅黑:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),"Microsoft YaHei":(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),Arial:(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC"),"Arial Unicode MS":(/Android|iPhone|iPad|iPod|Mobile|Tablet|HarmonyOS|MiuiBrowser|HuaweiBrowser/i.test(navigator.userAgent)?"Noto Sans SC Raised":"Noto Sans SC")},deviceFontRenderer:"canvas",`;
